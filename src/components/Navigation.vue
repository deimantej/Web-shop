        ...
        <v-navigation-drawer color="primary" v-model="drawer" app>
            ...
            <ul>
                ...
                <router-link tag="li" to="/menu">
                    <v-icon color="orange">restaurant_menu</v-icon>
                    Menu
                </router-link>

                <router-link tag="li" to="/about">
                    <v-icon color="inprogress">info</v-icon>
                    About
                </router-link>
                ...
                <router-link v-if="currentUser.isAdmin" tag="li" to="/admin">
                    <v-icon color="inprogress">lock</v-icon>
                    Admin
                </router-link>
                <router-link tag="li" v-if="currentUser" to="/orders" class="complete--text">
                    <v-icon color="complete">assignment</v-icon>
                    Orders
                </router-link>
            </ul>
        </v-navigation-drawer>
